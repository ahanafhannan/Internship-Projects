...
def payment(request):
    if agreementID == None:
        ...
        return render(request, 'agreement_homepage.html')
def grant(request):
    global base_url,user_name,password,app_key,app_secret,grant_response,id_token,prod
    ...
    create_request_parameter = {
        ...
        'callbackURL' : 'http://127.0.0.1:8000/main/execute',
        'amount' : '100',
        'currency' : 'BDT',
        'intent' : 'sale',
...
def create_agreement(response):
    ...
    create_request_parameter = {
        'mode' : "0000",
        'payerReference' : "01619777283",
        'callbackURL' : 'http://127.0.0.1:8000/main/execute_agreement',
        'amount' : '10',
        'currency' : 'BDT',
        'intent' : 'sale',
        'merchantInvoiceNumber' : '01992939478',
